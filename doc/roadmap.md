...
- `yield*` delegation now also accepts string values in addition to arrays and iterator-like objects, and now resumes correctly from nested block bodies.
