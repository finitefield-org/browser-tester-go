...
func TestInlineScriptsCanClickFavoriteCurrentButtonThroughPublicFacade(t *testing.T) {
	...
	if got, err := harness.ClassList("#favorite-current-button"); err != nil {
